...
```javascript
// tailwind.config.js
const baseConfig = require('@ynaa/shared-ui-theme/src/tailwind.config.js');
...
```tsx
import { ThemeProvider, defaultLightTheme } from '@ynaa/shared-ui-theme';
