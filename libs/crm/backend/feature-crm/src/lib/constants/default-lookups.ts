...
export const DEFAULT_CRM_LOOKUPS: ReadonlyArray<DefaultLookupEntry> = [
  ...
  {
    listKey: LOOKUP_LIST_KEYS.LEAD_STATUS,
    value: 'new',
    label: 'New',
    sortOrder: 10,
  },
  ...
  {
    listKey: LOOKUP_LIST_KEYS.LEAD_SOURCE,
    value: 'website',
    label: 'Website',
    sortOrder: 10,
  },
  ...
  {
    listKey: LOOKUP_LIST_KEYS.ACTIVITY_TYPE,
    value: 'note',
    label: 'Note',
    sortOrder: 10,
  },
  ...
  {
    listKey: LOOKUP_LIST_KEYS.CONTACT_STATUS,
    value: 'active',
    label: 'Active',
    sortOrder: 10,
  },
  ...
  {
    listKey: LOOKUP_LIST_KEYS.COMPANY_STATUS,
    value: 'active',
    label: 'Active',
    sortOrder: 10,
  },
  ...
  // Loss reasons
  {
    listKey: LOOKUP_LIST_KEYS.LOSS_REASON,
    value: 'price',
    label: 'Price',
    sortOrder: 10,
  },
